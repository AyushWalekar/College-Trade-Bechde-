    ...
    <footer>
		<div class="pagination">
			<%
				...
				{
			%>
	     		<a href="display2.jsp?page_no=<%=page_no-1%>" class="previous">Prev</a>
	     	...
	     	<% 
	     		...
	     		for(int i=1; i<=no_of_rows/2; i++)
	   			{	//2 posts per page is isly /2 kia
					...
					{
			%>
					<a href="display2.jsp?page_no=<%=page_no%>" class = "page active" ><%=page_no%></a>
					<!-- current page -->
			<%
					}
					else
					{
			%>
					<a href="display2.jsp?page_no=<%=i%>" class = "page" ><%=i%></a>
			...
			%>		
				<a href="display2.jsp?page_no=<%=page_no+1%>" class="next">Next</a>
